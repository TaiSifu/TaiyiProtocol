...
import { ISifusToken } from '@taiyi/contracts/contracts/interfaces/ISifusToken.sol';
...
contract Xumi is IWorldTimeline, ERC165, IERC721Receiver, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function _tokenSVG(uint256 /*_actor*/, uint256 _startY, uint256 /*_lineHeight*/) internal pure returns (string memory, uint256 _endY) {
        _endY = _startY;
        //所在时间线：须弥
        return (string(abi.encodePacked('<text x="10" y="', Strings.toString(_endY), '" class="base">\xE6\x89\x80\xE5\x9C\xA8\xE6\x97\xB6\xE9\x97\xB4\xE7\xBA\xBF\xEF\xBC\x9A\xE9\xA1\xBB\xE5\xBC\xA5</text>')), _endY);
    }

    function _tokenJSON(uint256 /*_actor*/) internal pure returns (string memory) {
        //须弥
        return '{"name":  "\xE9\xA1\xBB\xE5\xBC\xA5"}';
    }
