...
interface ITaiyiDaoExecutorInterface extends ethers.utils.Interface {
  functions: {
...
export class ITaiyiDaoExecutor extends Contract {
  ...
  interface: ITaiyiDaoExecutorInterface;
