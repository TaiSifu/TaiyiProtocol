...
interface DefaultWorldEventProcessorInterface extends ethers.utils.Interface {
  functions: {
...
export class DefaultWorldEventProcessor extends Contract {
  ...
  interface: DefaultWorldEventProcessorInterface;
