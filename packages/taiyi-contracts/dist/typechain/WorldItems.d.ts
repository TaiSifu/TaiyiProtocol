...
interface WorldItemsInterface extends ethers.utils.Interface {
  functions: {
...
export class WorldItems extends Contract {
  ...
  functions: {
    ...
    item(
      ...
      [
        ...
        _itemInfo: [BigNumber, string, BigNumber, string, BigNumber] & {
          typeId: BigNumber;
          typeName: string;
          shapeId: BigNumber;
          shapeName: string;
  ...
  itemShapes(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  itemTypes(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  itemWears(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  tokenURI(_itemId: BigNumberish, overrides?: CallOverrides): Promise<string>;
