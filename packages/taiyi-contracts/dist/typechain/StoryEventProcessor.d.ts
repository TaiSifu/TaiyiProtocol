...
interface StoryEventProcessorInterface extends ethers.utils.Interface {
  functions: {
...
export class StoryEventProcessor extends Contract {
  ...
  interface: StoryEventProcessorInterface;
