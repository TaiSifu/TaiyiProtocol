...
interface TaiyiDaoExecutorTestInterface extends ethers.utils.Interface {
  functions: {
...
export class TaiyiDaoExecutorTest extends Contract {
  ...
  interface: TaiyiDaoExecutorTestInterface;
