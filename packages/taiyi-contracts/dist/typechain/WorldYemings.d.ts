...
interface WorldYemingsInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setYeMing(uint256,address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setYeMing", data: BytesLike): Result;
...
export class WorldYemings extends Contract {
  ...
  interface: WorldYemingsInterface;

  functions: {
    YeMings(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    YeMings(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
