...
interface WorldZonesInterface extends ethers.utils.Interface {
  functions: {
    ...
    "updateZone(uint256,uint256,string)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "updateZone", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "validateName",
    data: BytesLike
  ): Result;
...
export class WorldZones extends Contract {
  ...
  functions: {
    ...
    timelines(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
    ...
    updateZone(
      _zoneOperator: BigNumberish,
      _zoneId: BigNumberish,
      _newName: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "updateZone(uint256,uint256,string)"(
      _zoneOperator: BigNumberish,
      _zoneId: BigNumberish,
      _newName: string,
      overrides?: Overrides & { from?: string | Promise<string> }
  ...
  tokenURI(_zoneId: BigNumberish, overrides?: CallOverrides): Promise<string>;
