...
interface TaiyiDaoLogicV1HarnessInterface extends ethers.utils.Interface {
  functions: {
...
export class TaiyiDaoLogicV1Harness extends Contract {
  ...
  interface: TaiyiDaoLogicV1HarnessInterface;
