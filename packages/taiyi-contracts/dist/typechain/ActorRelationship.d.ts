...
interface ActorRelationshipInterface extends ethers.utils.Interface {
  functions: {
...
export class ActorRelationship extends Contract {
  ...
  interface: ActorRelationshipInterface;
