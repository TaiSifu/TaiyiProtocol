...
interface WorldContractRouteInterface extends ethers.utils.Interface {
  functions: {
...
export class WorldContractRoute extends Contract {
  ...
  interface: WorldContractRouteInterface;
