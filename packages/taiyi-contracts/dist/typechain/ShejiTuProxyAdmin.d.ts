...
interface ShejiTuProxyAdminInterface extends ethers.utils.Interface {
  functions: {
...
export class ShejiTuProxyAdmin extends Contract {
  ...
  interface: ShejiTuProxyAdminInterface;
