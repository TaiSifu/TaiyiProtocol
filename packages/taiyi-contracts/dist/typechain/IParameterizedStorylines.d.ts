...
interface IParameterizedStorylinesInterface extends ethers.utils.Interface {
  functions: {
...
export class IParameterizedStorylines extends Contract {
  ...
  interface: IParameterizedStorylinesInterface;
