...
interface LogisticToLinearVrgdaInterface extends ethers.utils.Interface {
  functions: {
...
export class LogisticToLinearVrgda extends Contract {
  ...
  interface: LogisticToLinearVrgdaInterface;
