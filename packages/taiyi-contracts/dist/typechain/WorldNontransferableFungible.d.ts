...
interface WorldNontransferableFungibleInterface extends ethers.utils.Interface {
  functions: {
...
export class WorldNontransferableFungible extends Contract {
  ...
  interface: WorldNontransferableFungibleInterface;
