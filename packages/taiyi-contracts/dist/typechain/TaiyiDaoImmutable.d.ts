...
interface TaiyiDaoImmutableInterface extends ethers.utils.Interface {
  functions: {
...
export class TaiyiDaoImmutable extends Contract {
  ...
  interface: TaiyiDaoImmutableInterface;
