...
interface TaiyiDaoExecutorHarnessInterface extends ethers.utils.Interface {
  functions: {
...
export class TaiyiDaoExecutorHarness extends Contract {
  ...
  interface: TaiyiDaoExecutorHarnessInterface;
