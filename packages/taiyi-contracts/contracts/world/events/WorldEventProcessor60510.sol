...
contract WorldEventProcessor60510 is DefaultWorldEventProcessor {
    ...
    function checkOccurrence(uint256 _actor, uint256 /*_age*/) external virtual view override returns (bool) {
        ...
        if(!IWorldVillages(worldRoute.modules(WorldConstants.WORLD_MODULE_VILLAGES)).isZoneVillage(lc[0])) {
        ...
        if(behavior.attributesScores(ActorBehaviorAttributesConstants.ACT, _actor) < 5) {
