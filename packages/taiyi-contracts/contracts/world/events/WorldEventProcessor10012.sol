...
contract WorldEventProcessor10012 is DefaultWorldEventProcessor, ERC721Holder {
    ...
    function eventInfo(uint256 /*_actor*/) external virtual view override returns (string memory) {
        //你父母又生了个女儿。
        return "\xE4\xBD\xA0\xE7\x88\xB6\xE6\xAF\x8D\xE5\x8F\x88\xE7\x94\x9F\xE4\xBA\x86\xE4\xB8\xAA\xE5\xA5\xB3\xE5\x84\xBF\xE3\x80\x82";
    }
    //坤为地（坤卦）厚德载物
        ...
        onlyYeMing(_operator)
    {
        ...
        talents.setActorTalent(_operator, newActor, 1004); //生而为女
        talents.setActorTalent(_operator, newActor, 1017); //有哥哥姐姐

        //set relationship
        IActorRelationship relationship = IActorRelationship(worldRoute.modules(WorldConstants.WORLD_MODULE_RELATIONSHIP));
        relationship.setActorRelation(_operator, _actor, newActor, 5); //姐妹
    }
