...
contract WorldZoneBaseResources is IWorldZoneBaseResources, WorldConfigurable, Ownable {
    ...
    function _growAssets(uint256 _operator, uint256 _zoneId, uint256 _dt) internal {
        ...
        IWorldFungible food = IWorldFungible(worldRoute.modules(WorldConstants.WORLD_MODULE_FOOD));
        IWorldFungible herb = IWorldFungible(worldRoute.modules(WorldConstants.WORLD_MODULE_HERB));
        ...
        if(_dt >= GROW_TIME_DAY) {
            ...
            zoneAssets[_zoneId][WorldConstants.WORLD_MODULE_GOLD] += grownGold;
            ...
            zoneAssets[_zoneId][WorldConstants.WORLD_MODULE_FOOD] += grownFood;
            ...
            zoneAssets[_zoneId][WorldConstants.WORLD_MODULE_HERB] += grownHerb;
            ...
            zoneAssets[_zoneId][WorldConstants.WORLD_MODULE_FABRIC] += grownFabric;
            ...
            zoneAssets[_zoneId][WorldConstants.WORLD_MODULE_WOOD] += grownWood;
