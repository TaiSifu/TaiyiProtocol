...
/// @title The Taiyi DAO proxy contract
...
// LICENSE
// TaiyiDAOProxy.sol is a modified version of Compound Lab's GovernorBravoDelegator.sol:
...
//
//
// TaiyiDAOProxy.sol uses parts of Open Zeppelin's Proxy.sol:
...
contract TaiyiDAOProxy is TaiyiDAOProxyStorage, TaiyiDAOEvents {
    constructor(
        address timelock_,
        address sifus_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, 'TaiyiDAOProxy::_setImplementation: admin only');
        require(implementation_ != address(0), 'TaiyiDAOProxy::_setImplementation: invalid implementation address');
