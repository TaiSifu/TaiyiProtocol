...
interface WorldEventProcessor1030002Interface extends ethers.utils.Interface {
  functions: {
    ...
    "starActors(uint256)": FunctionFragment;
    "starNum()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "starActors",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "starNum", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "starActors", data: BytesLike): Result;
  decodeFunctionResult(functionFragment: "starNum", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export class WorldEventProcessor1030002 extends Contract {
  ...
  interface: WorldEventProcessor1030002Interface;
  ...
  functions: {
    ...
    starNum(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  starActors(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    starNum(overrides?: CallOverrides): Promise<PopulatedTransaction>;
