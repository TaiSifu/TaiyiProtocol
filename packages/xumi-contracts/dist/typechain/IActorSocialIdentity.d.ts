...
interface IActorSocialIdentityInterface extends ethers.utils.Interface {
  functions: {
...
export class IActorSocialIdentity extends Contract {
  ...
  interface: IActorSocialIdentityInterface;
  ...
  functions: {
    ...
    names(_nameid: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    names(_nameid: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
