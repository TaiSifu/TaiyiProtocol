...
describe('剧情测试', () => {
    ...
    describe('全局剧情70001', () => {
        ...
        it(`未授权角色给剧情的情况`, () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield parameterizedStorylines.isStoryExist(70001)).to.eq(false);
            let lcs = yield actorLocations.actorLocations(testActor);
            yield expect(shejiTu.activeTrigger(60505, testActor, [lcs[1]], [])).to.be.revertedWith("not approved or owner of actor");
        }));
