...
interface WorldEventProcessor80003Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80003 extends Contract {
  ...
  interface: WorldEventProcessor80003Interface;
