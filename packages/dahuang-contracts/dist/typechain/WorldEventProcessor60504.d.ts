...
interface WorldEventProcessor60504Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60504 extends Contract {
  ...
  interface: WorldEventProcessor60504Interface;
