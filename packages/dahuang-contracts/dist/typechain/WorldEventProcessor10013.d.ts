...
interface WorldEventProcessor10013Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10013 extends Contract {
  ...
  interface: WorldEventProcessor10013Interface;
