...
interface WorldEventProcessor60510Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60510 extends Contract {
  ...
  interface: WorldEventProcessor60510Interface;
