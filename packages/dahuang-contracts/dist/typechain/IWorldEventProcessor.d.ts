...
interface IWorldEventProcessorInterface extends ethers.utils.Interface {
  functions: {
...
export class IWorldEventProcessor extends Contract {
  ...
  interface: IWorldEventProcessorInterface;
