...
interface ActorMoodAttributesInterface extends ethers.utils.Interface {
  functions: {
...
export class ActorMoodAttributes extends Contract {
  ...
  interface: ActorMoodAttributesInterface;
