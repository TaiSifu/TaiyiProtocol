...
interface WorldEventProcessor70001Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor70001 extends Contract {
  ...
  interface: WorldEventProcessor70001Interface;
