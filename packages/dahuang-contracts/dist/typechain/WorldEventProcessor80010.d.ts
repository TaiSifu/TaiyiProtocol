...
interface WorldEventProcessor80010Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80010 extends Contract {
  ...
  interface: WorldEventProcessor80010Interface;
