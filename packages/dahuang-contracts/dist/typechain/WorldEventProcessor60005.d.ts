...
interface WorldEventProcessor60005Interface extends ethers.utils.Interface {
  functions: {
    ...
    "genesis_left()": FunctionFragment;
    "genesis_numbers(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "genesis_left",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "genesis_numbers",
    values: [BigNumberish]
  ): string;
...
export class WorldEventProcessor60005 extends Contract {
  ...
  interface: WorldEventProcessor60005Interface;
  ...
  functions: {
    ...
    genesis_left(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    genesis_left(overrides?: CallOverrides): Promise<PopulatedTransaction>;
