...
interface FakeWorldFungibleInterface extends ethers.utils.Interface {
  functions: {
...
export class FakeWorldFungible extends Contract {
  ...
  interface: FakeWorldFungibleInterface;
