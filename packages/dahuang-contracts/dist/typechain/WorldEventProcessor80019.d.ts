...
interface WorldEventProcessor80019Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80019 extends Contract {
  ...
  interface: WorldEventProcessor80019Interface;
