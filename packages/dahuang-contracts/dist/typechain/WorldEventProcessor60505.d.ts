...
interface WorldEventProcessor60505Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60505 extends Contract {
  ...
  interface: WorldEventProcessor60505Interface;
