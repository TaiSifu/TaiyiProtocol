...
interface WorldEventProcessor10025Interface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "zoneTaiyi", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "zoneTaiyi", data: BytesLike): Result;
...
export class WorldEventProcessor10025 extends Contract {
  ...
  interface: WorldEventProcessor10025Interface;
  ...
  functions: {
    ...
    zoneTaiyi(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    zoneTaiyi(overrides?: CallOverrides): Promise<PopulatedTransaction>;
