...
interface WorldEventProcessor10000Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10000 extends Contract {
  ...
  interface: WorldEventProcessor10000Interface;
