...
interface WorldEventProcessor60521Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60521 extends Contract {
  ...
  interface: WorldEventProcessor60521Interface;
