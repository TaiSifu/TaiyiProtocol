...
interface WorldEventProcessor10021Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10021 extends Contract {
  ...
  interface: WorldEventProcessor10021Interface;
