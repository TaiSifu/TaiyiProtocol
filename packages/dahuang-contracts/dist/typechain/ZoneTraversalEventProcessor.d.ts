...
interface ZoneTraversalEventProcessorInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setTargetZoneId(uint256)": FunctionFragment;
    "targetZone()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setTargetZoneId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "targetZone",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "targetZone", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export class ZoneTraversalEventProcessor extends Contract {
  ...
  interface: ZoneTraversalEventProcessorInterface;
  ...
  functions: {
    ...
    "setTargetZoneId(uint256)"(
      _zoneId: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    targetZone(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    targetZone(overrides?: CallOverrides): Promise<PopulatedTransaction>;
