...
interface WorldEventProcessor10003Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10003 extends Contract {
  ...
  interface: WorldEventProcessor10003Interface;
