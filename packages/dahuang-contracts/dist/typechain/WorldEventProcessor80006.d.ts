...
interface WorldEventProcessor80006Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80006 extends Contract {
  ...
  interface: WorldEventProcessor80006Interface;
