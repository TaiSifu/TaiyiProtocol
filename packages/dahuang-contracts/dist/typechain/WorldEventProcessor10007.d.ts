...
interface WorldEventProcessor10007Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10007 extends Contract {
  ...
  interface: WorldEventProcessor10007Interface;
