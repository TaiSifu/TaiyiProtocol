...
interface ActorTalentProcessor1050Interface extends ethers.utils.Interface {
  functions: {
...
export class ActorTalentProcessor1050 extends Contract {
  ...
  interface: ActorTalentProcessor1050Interface;
