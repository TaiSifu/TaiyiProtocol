...
interface WorldEventProcessor10006Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10006 extends Contract {
  ...
  interface: WorldEventProcessor10006Interface;
