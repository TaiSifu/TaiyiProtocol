...
interface WorldEventProcessor10010Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10010 extends Contract {
  ...
  interface: WorldEventProcessor10010Interface;
