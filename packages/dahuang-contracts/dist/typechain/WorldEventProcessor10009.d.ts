...
interface WorldEventProcessor10009Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10009 extends Contract {
  ...
  interface: WorldEventProcessor10009Interface;
