...
interface WorldEventProcessor10033Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10033 extends Contract {
  ...
  interface: WorldEventProcessor10033Interface;
