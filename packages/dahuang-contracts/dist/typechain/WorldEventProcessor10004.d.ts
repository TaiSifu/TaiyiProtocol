...
interface WorldEventProcessor10004Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10004 extends Contract {
  ...
  interface: WorldEventProcessor10004Interface;
