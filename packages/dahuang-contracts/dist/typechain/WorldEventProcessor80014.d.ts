...
interface WorldEventProcessor80014Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80014 extends Contract {
  ...
  interface: WorldEventProcessor80014Interface;
