...
interface WorldEventProcessor10024Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10024 extends Contract {
  ...
  interface: WorldEventProcessor10024Interface;
