...
interface WorldEventProcessor80007Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80007 extends Contract {
  ...
  interface: WorldEventProcessor80007Interface;
