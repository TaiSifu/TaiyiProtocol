...
interface ActorCharmAttributesInterface extends ethers.utils.Interface {
  functions: {
...
export class ActorCharmAttributes extends Contract {
  ...
  interface: ActorCharmAttributesInterface;
