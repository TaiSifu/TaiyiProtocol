...
interface WorldEventProcessor60508Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60508 extends Contract {
  ...
  interface: WorldEventProcessor60508Interface;
