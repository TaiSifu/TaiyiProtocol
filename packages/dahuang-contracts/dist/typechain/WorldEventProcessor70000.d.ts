...
interface WorldEventProcessor70000Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor70000 extends Contract {
  ...
  interface: WorldEventProcessor70000Interface;
