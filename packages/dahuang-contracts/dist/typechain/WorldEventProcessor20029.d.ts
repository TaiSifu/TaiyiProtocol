...
interface WorldEventProcessor20029Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor20029 extends Contract {
  ...
  interface: WorldEventProcessor20029Interface;
