...
interface WorldEventProcessor10022Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10022 extends Contract {
  ...
  interface: WorldEventProcessor10022Interface;
