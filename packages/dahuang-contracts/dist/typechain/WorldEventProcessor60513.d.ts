...
interface WorldEventProcessor60513Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60513 extends Contract {
  ...
  interface: WorldEventProcessor60513Interface;
