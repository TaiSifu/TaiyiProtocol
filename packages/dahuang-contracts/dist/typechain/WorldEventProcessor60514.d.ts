...
interface WorldEventProcessor60514Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60514 extends Contract {
  ...
  interface: WorldEventProcessor60514Interface;
