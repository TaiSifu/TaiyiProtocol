...
interface WorldEventProcessor10026Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10026 extends Contract {
  ...
  interface: WorldEventProcessor10026Interface;
