...
interface WorldEventProcessor80016Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80016 extends Contract {
  ...
  interface: WorldEventProcessor80016Interface;
