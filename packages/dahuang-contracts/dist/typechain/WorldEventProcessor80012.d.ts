...
interface WorldEventProcessor80012Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80012 extends Contract {
  ...
  interface: WorldEventProcessor80012Interface;
