...
interface WorldSeasonsInterface extends ethers.utils.Interface {
  functions: {
...
export class WorldSeasons extends Contract {
  ...
  interface: WorldSeasonsInterface;
  ...
  seasonLabels(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
