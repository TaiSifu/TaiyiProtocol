...
interface WorldEventProcessor60512Interface extends ethers.utils.Interface {
  functions: {
    "BASE_BUILD_TIME()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "BASE_BUILD_TIME",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class WorldEventProcessor60512 extends Contract {
  ...
  interface: WorldEventProcessor60512Interface;

  functions: {
    BASE_BUILD_TIME(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    BASE_BUILD_TIME(overrides?: CallOverrides): Promise<PopulatedTransaction>;
