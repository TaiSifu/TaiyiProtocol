...
interface ActorCoreAttributesInterface extends ethers.utils.Interface {
  functions: {
...
export class ActorCoreAttributes extends Contract {
  ...
  interface: ActorCoreAttributesInterface;
