...
interface WorldEventProcessor80008Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80008 extends Contract {
  ...
  interface: WorldEventProcessor80008Interface;
