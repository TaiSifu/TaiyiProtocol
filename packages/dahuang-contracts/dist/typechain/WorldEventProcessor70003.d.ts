...
interface WorldEventProcessor70003Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor70003 extends Contract {
  ...
  interface: WorldEventProcessor70003Interface;
