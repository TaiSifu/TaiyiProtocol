...
interface ActorTalentProcessor1010Interface extends ethers.utils.Interface {
  functions: {
...
export class ActorTalentProcessor1010 extends Contract {
  ...
  interface: ActorTalentProcessor1010Interface;
