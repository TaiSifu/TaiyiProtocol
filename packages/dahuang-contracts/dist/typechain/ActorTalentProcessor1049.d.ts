...
interface ActorTalentProcessor1049Interface extends ethers.utils.Interface {
  functions: {
...
export class ActorTalentProcessor1049 extends Contract {
  ...
  interface: ActorTalentProcessor1049Interface;
