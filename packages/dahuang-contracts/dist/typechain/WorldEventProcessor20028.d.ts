...
interface WorldEventProcessor20028Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor20028 extends Contract {
  ...
  interface: WorldEventProcessor20028Interface;
