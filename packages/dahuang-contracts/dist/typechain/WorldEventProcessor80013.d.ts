...
interface WorldEventProcessor80013Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80013 extends Contract {
  ...
  interface: WorldEventProcessor80013Interface;
