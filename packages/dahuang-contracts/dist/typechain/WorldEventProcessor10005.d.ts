...
interface WorldEventProcessor10005Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10005 extends Contract {
  ...
  interface: WorldEventProcessor10005Interface;
