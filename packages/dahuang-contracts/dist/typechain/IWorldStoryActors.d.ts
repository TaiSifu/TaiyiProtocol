...
interface IWorldStoryActorsInterface extends ethers.utils.Interface {
  functions: {
...
export class IWorldStoryActors extends Contract {
  ...
  interface: IWorldStoryActorsInterface;
