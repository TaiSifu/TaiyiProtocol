...
interface WorldEventProcessor10001Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10001 extends Contract {
  ...
  interface: WorldEventProcessor10001Interface;
