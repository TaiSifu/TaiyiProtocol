...
interface WorldEventProcessor10111Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10111 extends Contract {
  ...
  interface: WorldEventProcessor10111Interface;
