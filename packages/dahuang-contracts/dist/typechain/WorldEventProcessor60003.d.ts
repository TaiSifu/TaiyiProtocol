...
interface WorldEventProcessor60003Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60003 extends Contract {
  ...
  interface: WorldEventProcessor60003Interface;
