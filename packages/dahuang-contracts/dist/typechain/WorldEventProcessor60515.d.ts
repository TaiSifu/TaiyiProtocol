...
interface WorldEventProcessor60515Interface extends ethers.utils.Interface {
  functions: {
    "activeTrigger(uint256,uint256,uint256[],string[])": FunctionFragment;
    "calcDaoliByAssets(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calcDaoliByAssets",
  ...
  encodeFunctionData(
    functionFragment: "eventOperator",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "evt60514Address",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isFundInPosition",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(functionFragment: "taiyiZone", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "taiyiZone", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export class WorldEventProcessor60515 extends Contract {
  ...
  interface: WorldEventProcessor60515Interface;
  ...
  functions: {
    ...
    calcDaoliByAssets(
      _assetModuleId: BigNumberish,
      _assetAmount: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    "calcDaoliByAssets(uint256,uint256)"(
      _assetModuleId: BigNumberish,
      _assetAmount: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
    ...
    eventOperator(overrides?: CallOverrides): Promise<[BigNumber]>;

    "eventOperator()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    evt60514Address(overrides?: CallOverrides): Promise<[string]>;
    ...
    isFundInPosition(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    taiyiZone(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    evt60514Address(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    eventOperator(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "eventOperator()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    evt60514Address(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    isFundInPosition(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    taiyiZone(overrides?: CallOverrides): Promise<PopulatedTransaction>;
