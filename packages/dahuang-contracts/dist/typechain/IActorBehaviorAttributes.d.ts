...
interface IActorBehaviorAttributesInterface extends ethers.utils.Interface {
  functions: {
...
export class IActorBehaviorAttributes extends Contract {
  ...
  interface: IActorBehaviorAttributesInterface;
