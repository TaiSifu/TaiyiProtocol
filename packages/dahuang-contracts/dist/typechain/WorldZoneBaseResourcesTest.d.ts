...
interface WorldZoneBaseResourcesTestInterface extends ethers.utils.Interface {
  functions: {
...
export class WorldZoneBaseResourcesTest extends Contract {
  ...
  interface: WorldZoneBaseResourcesTestInterface;
