...
interface WorldEventProcessor80015Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80015 extends Contract {
  ...
  interface: WorldEventProcessor80015Interface;
