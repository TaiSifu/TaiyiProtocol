...
interface WorldEventProcessor60523Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60523 extends Contract {
  ...
  interface: WorldEventProcessor60523Interface;
