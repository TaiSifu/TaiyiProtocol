...
interface WorldZoneBaseResourcesInterface extends ethers.utils.Interface {
  functions: {
...
export class WorldZoneBaseResources extends Contract {
  ...
  interface: WorldZoneBaseResourcesInterface;
