...
interface WorldEventProcessor10017Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10017 extends Contract {
  ...
  interface: WorldEventProcessor10017Interface;
