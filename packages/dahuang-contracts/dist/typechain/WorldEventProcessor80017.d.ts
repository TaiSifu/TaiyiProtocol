...
interface WorldEventProcessor80017Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80017 extends Contract {
  ...
  interface: WorldEventProcessor80017Interface;
