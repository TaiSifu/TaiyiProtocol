...
interface WorldEventProcessor10062Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10062 extends Contract {
  ...
  interface: WorldEventProcessor10062Interface;
