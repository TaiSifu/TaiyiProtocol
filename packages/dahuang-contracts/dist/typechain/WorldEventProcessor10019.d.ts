...
interface WorldEventProcessor10019Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10019 extends Contract {
  ...
  interface: WorldEventProcessor10019Interface;
