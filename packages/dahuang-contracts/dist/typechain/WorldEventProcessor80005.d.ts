...
interface WorldEventProcessor80005Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80005 extends Contract {
  ...
  interface: WorldEventProcessor80005Interface;
