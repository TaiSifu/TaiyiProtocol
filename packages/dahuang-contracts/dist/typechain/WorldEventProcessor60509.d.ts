...
interface WorldEventProcessor60509Interface extends ethers.utils.Interface {
  functions: {
    "BASE_TRAVEL_TIME()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "BASE_TRAVEL_TIME",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class WorldEventProcessor60509 extends Contract {
  ...
  interface: WorldEventProcessor60509Interface;

  functions: {
    BASE_TRAVEL_TIME(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    BASE_TRAVEL_TIME(overrides?: CallOverrides): Promise<PopulatedTransaction>;
