...
interface WorldEventProcessor10008Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10008 extends Contract {
  ...
  interface: WorldEventProcessor10008Interface;
