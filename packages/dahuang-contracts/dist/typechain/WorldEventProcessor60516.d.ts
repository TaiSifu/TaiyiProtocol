...
interface WorldEventProcessor60516Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60516 extends Contract {
  ...
  interface: WorldEventProcessor60516Interface;
