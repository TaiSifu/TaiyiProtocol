...
interface WorldEventProcessor60522Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor60522 extends Contract {
  ...
  interface: WorldEventProcessor60522Interface;
