...
interface WorldEventProcessor50002Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor50002 extends Contract {
  ...
  interface: WorldEventProcessor50002Interface;
