...
interface ActorsGenderInterface extends ethers.utils.Interface {
  functions: {
    ...
    "asexualActors(uint256)": FunctionFragment;
    "asexualNum()": FunctionFragment;
    "bisexualActors(uint256)": FunctionFragment;
    "bisexualNum()": FunctionFragment;
    "femaleActors(uint256)": FunctionFragment;
    "femaleNum()": FunctionFragment;
    "maleActors(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "asexualActors",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "bisexualActors",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "maleActors", data: BytesLike): Result;
...
export class ActorsGender extends Contract {
  ...
  interface: ActorsGenderInterface;
  ...
  femaleActors(arg0: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  maleActors(arg0: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
