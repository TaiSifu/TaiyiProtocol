...
interface WorldEventProcessor10027Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10027 extends Contract {
  ...
  interface: WorldEventProcessor10027Interface;
