...
interface WorldEventProcessor10014Interface extends ethers.utils.Interface {
  functions: {
    "activeTrigger(uint256,uint256,uint256[],string[])": FunctionFragment;
    "actors_to_be_claimed(uint256,uint256)": FunctionFragment;
    "checkBranch(uint256,uint256)": FunctionFragment;
    "checkOccurrence(uint256,uint256)": FunctionFragment;
    "claimActor(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "actors_to_be_claimed",
  ...
  decodeFunctionResult(functionFragment: "claimActor", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "defaultBranchEvent",
    data: BytesLike
  ): Result;
...
export class WorldEventProcessor10014 extends Contract {
  ...
  interface: WorldEventProcessor10014Interface;
  ...
  functions: {
    ...
    actors_to_be_claimed(
      arg0: BigNumberish,
      arg1: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    "actors_to_be_claimed(uint256,uint256)"(
      arg0: BigNumberish,
      arg1: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  trigrams(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber[]>;
  ...
  callStatic: {
    ...
    claimActor(_actor: BigNumberish, overrides?: CallOverrides): Promise<void>;
