...
interface WorldEventProcessor80018Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor80018 extends Contract {
  ...
  interface: WorldEventProcessor80018Interface;
