...
interface WorldEventProcessor10002Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10002 extends Contract {
  ...
  interface: WorldEventProcessor10002Interface;
