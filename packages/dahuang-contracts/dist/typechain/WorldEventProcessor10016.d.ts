...
interface WorldEventProcessor10016Interface extends ethers.utils.Interface {
  functions: {
...
export class WorldEventProcessor10016 extends Contract {
  ...
  interface: WorldEventProcessor10016Interface;
