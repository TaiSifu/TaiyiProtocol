...
interface FakeActorBornPlacesInterface extends ethers.utils.Interface {
  functions: {
...
export class FakeActorBornPlaces extends Contract {
  ...
  interface: FakeActorBornPlacesInterface;
