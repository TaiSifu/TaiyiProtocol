...
contract WorldEventProcessor10022 is DefaultWorldEventProcessor {
    constructor(WorldContractRoute _route) DefaultWorldEventProcessor(_route, 0) {}
    function eventInfo(uint256 /*_actor*/) external virtual view override returns (string memory) {
        //你什么事都要让着妹妹。
        return "\xE4\xBD\xA0\xE4\xBB\x80\xE4\xB9\x88\xE4\xBA\x8B\xE9\x83\xBD\xE8\xA6\x81\xE8\xAE\xA9\xE7\x9D\x80\xE5\xA6\xB9\xE5\xA6\xB9\xE3\x80\x82";
    }
    //风天小畜（小畜卦）蓄养待进
    ...
    function checkOccurrence(uint256 _actor, uint256 /*_age*/) external view override returns (bool) {
        ...
        //"(EVT?[10022,10014])|(TLT?[1015])"
        if(evts.actorEventCount(_actor, 10022) > 0)
            return false;
        ...
        if(evts.actorEventCount(_actor, 10012) > 0)
            return true;
