...
contract WorldEventProcessor10020 is DefaultWorldEventProcessor {
    constructor(WorldContractRoute _route) DefaultWorldEventProcessor(_route, 0) {}
    function eventInfo(uint256 /*_actor*/) external virtual view override returns (string memory) {
        //你天资聪颖，但家人并不懂如何培养。
        return "\xE4\xBD\xA0\xE5\xA4\xA9\xE8\xB5\x84\xE8\x81\xAA\xE9\xA2\x96\xEF\xBC\x8C\xE4\xBD\x86\xE5\xAE\xB6\xE4\xBA\xBA\xE5\xB9\xB6\xE4\xB8\x8D\xE6\x87\x82\xE5\xA6\x82\xE4\xBD\x95\xE5\x9F\xB9\xE5\x85\xBB\xE3\x80\x82";
    }
    //风天小畜（小畜卦）蓄养待进
    ...
    function checkOccurrence(uint256 _actor, uint256 /*_age*/) external view override returns (bool) {
        ...
        if(evts.actorEventCount(_actor, 10009) > 0 && coreAttrs.attributesScores(DahuangConstants.ATTR_WUX, _actor) >= 70)
            return true;
