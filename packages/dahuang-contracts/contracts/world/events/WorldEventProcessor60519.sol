...
contract WorldEventProcessor60519 is DefaultWorldEventProcessor {
    ...
    function eventInfo(uint256 /*_actor*/) external virtual view override returns (string memory) {
        //村民为你制作了简陋的青铜铸炉。
        return "\xE6\x9D\x91\xE6\xB0\x91\xE4\xB8\xBA\xE4\xBD\xA0\xE5\x88\xB6\xE4\xBD\x9C\xE4\xBA\x86\xE7\xAE\x80\xE9\x99\x8B\xE7\x9A\x84\xE9\x9D\x92\xE9\x93\x9C\xE9\x93\xB8\xE7\x82\x89\xE3\x80\x82";
    }
    ...
    function checkOccurrence(uint256 _actor, uint256 /*_age*/) external virtual view override returns (bool) {
        ...
        if(gold.balanceOfActor(_actor) < 10e18) {
        ...
        onlyYeMing(_operator)
    {
        ...
        //消耗资源
        IWorldFungible gold = IWorldFungible(worldRoute.modules(DahuangConstants.WORLD_MODULE_GOLD));
        gold.transferFromActor(_operator, _actor, _operator, 10e18);
    }
}
