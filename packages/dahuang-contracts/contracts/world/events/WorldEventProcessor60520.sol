...
contract WorldEventProcessor60520 is DefaultWorldEventProcessor {
    ...
    function eventInfo(uint256 /*_actor*/) external virtual view override returns (string memory) {
        //村民为你制作了简陋的黑石砂。
        return "\xE6\x9D\x91\xE6\xB0\x91\xE4\xB8\xBA\xE4\xBD\xA0\xE5\x88\xB6\xE4\xBD\x9C\xE4\xBA\x86\xE7\xAE\x80\xE9\x99\x8B\xE7\x9A\x84\xE9\xBB\x91\xE7\x9F\xB3\xE7\xA0\x82\xE3\x80\x82";
    }
    ...
    function checkOccurrence(uint256 _actor, uint256 /*_age*/) external virtual view override returns (bool) {
        ...
        if(wood.balanceOfActor(_actor) < 5e18) {
        ...
        if(fabric.balanceOfActor(_actor) < 2e18)
            return false;
        ...
        onlyYeMing(_operator)
    {
        ...
        IWorldFungible wood = IWorldFungible(worldRoute.modules(DahuangConstants.WORLD_MODULE_WOOD));
        wood.transferFromActor(_operator, _actor, _operator, 5e18);
        IWorldFungible fabric = IWorldFungible(worldRoute.modules(DahuangConstants.WORLD_MODULE_FABRIC));
        fabric.transferFromActor(_operator, _actor, _operator, 2e18);
    }
}
